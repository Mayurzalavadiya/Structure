...
import com.starter.app.databinding.FragmentBluetoothBinding
import com.starter.app.ui.base.BaseFragment
import com.starter.app.ui.adapter.BluetoothDeviceAdapter
        ...
        override fun onReceive(context: Context, intent: Intent) {
            when (intent.action) {
                ...
                BluetoothAdapter.ACTION_DISCOVERY_STARTED -> {
                    ...
                    showLoader()
                    binding.textViewStatus.text = "Scanning..."
                }
